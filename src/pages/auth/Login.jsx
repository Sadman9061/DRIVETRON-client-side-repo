  ...
  const handleGoogle = ()=>{
    ...
    return (
        <div className="flex flex-col lg:flex-row-reverse justify-between items-center my-10 ">
            <img className="w-96 md:w-full " src="https://img.freepik.com/free-vector/privacy-policy-concept-illustration_114360-7853.jpg?size=626&ext=jpg&ga=GA1.1.1562393880.1694619529&semt=sph" alt="" />
            <form onSubmit={handleLogin}>
                <div className="mx-2 md:20 lg:ml-40  relative flex w-60 md:w-96 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md border ">
                    ...
                    <div className="p-6 pt-0 ">
                        <input className="form-control block w-full select-none  py-3 px-6 text-center align-middle font-sans text-xs font-bold   shadow-md shadow-[#b0dddd] transition-all hover:shadow-lg hover:shadow-[#52e4e4] active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none btn btn-primary bg-gradient-to-r from-[#52e4e4] to-blue-500 hover:from-[#30e0e0] hover:to-[#3273fd] border-none rounded-full text-black   normal-case"
                        ...
                        <Link className="ml-1 block font-sans text-sm font-bold leading-normal bg-gradient-to-l from-blue-500 to-[#52e4e4] text-center  bg-clip-text text-transparent antialiased
                            " to='/registration'>Sign up</Link>
                        </div>
                        <div>
                   <h1 className="text-center">or</h1>
                      <div className="flex justify-center my-4 items-center "><FcGoogle onClick={handleGoogle} className=' text-4xl w-full   py-3 px-6 text-center   font-bold     btn border-black    rounded-full    normal-case'></FcGoogle></div>
                   </div>
